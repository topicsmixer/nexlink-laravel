            ...
            <form action="{{ route('admin.default-dashboard') }}">
              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="http://../authentication/forgot-password-frame.html">Forgot Password?</a>
                </div>
              </div>
              <div class="mb-3">
                <button type="submit" value="Submit" class="btn btn-primary waves-effect waves-light w-100">Login</button>
              </div>
              <p class="mb-5 text-center">Don’t have an account? <a href="http://../authentication/register-frame.html">Sign Up here</a>
              </p>
